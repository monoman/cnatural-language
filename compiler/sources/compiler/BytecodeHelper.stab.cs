...
namespace cnatural.compiler {
    ...
    public static class BytecodeHelper {
        ...
        public static bool hasImplicitConversion(TypeInfo fromType, TypeInfo toType) {
            if (fromType == null) {
        ...
        public static bool isCompiledToObject(TypeInfo type) {
            if (type.IsObject) {
                return true;
            }
        ...
        static bool isDelegateType(TypeInfo type) {
        ...
        static bool isExpressionTreeType(TypeInfo type) {
            return type.FullName.equals("stab/tree/ExpressionTree");
        }
    
        static bool isIterableType(TypeInfo type) {
        ...
        public static bool isIndexerGet(AnnotationValue annotation) {
        ...
        public static bool isPropertyGet(AnnotationValue annotation) {
