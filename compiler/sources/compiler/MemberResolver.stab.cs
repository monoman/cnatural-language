...
namespace cnatural.compiler {
    ...
    public class MemberResolver {
        ...
        public bool isAmbiguousTypeName(String name) {
            var s = scope;
            do {
        ...
        public void enterMethod(MethodInfo method, bool statementScope) {
        ...
        private void enterScopeCore(bool statementScope) {
        ...
        private class Scope {
            ...
            Scope(bool statementScope, Scope next) {
