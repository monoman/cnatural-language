...
namespace cnatural.compiler {
    ...
    class AssignmentChecker : StatementHandler<HashSet<StatementNode>, Boolean> {
        ...
        private class AssignmentExpressionChecker : ExpressionHandler<HashSet<StatementNode>, AssignmentState> {
            ...
            protected override AssignmentState handleBinary(BinaryExpressionNode binary, HashSet<StatementNode> visited, bool nested) {
            ...
            protected override AssignmentState handleSizeof(SizeofExpressionNode sizeofExpr, HashSet<StatementNode> visited, bool nested) {
            ...
            protected override AssignmentState handleTypeof(TypeofExpressionNode typeofExpr, HashSet<StatementNode> visited, bool nested) {
                return AssignmentState.NotAssigned;
            }
            
            protected override AssignmentState handleUnary(UnaryExpressionNode unary, HashSet<StatementNode> visited, bool nested) {
