...
namespace stab.reflection {
    ...
    public class TypeBuilder : ObjectTypeInfo {
        ...
        public void setAnnotation(bool value) {
            setModifier(Opcodes.ACC_ANNOTATION, value);
        }

        public void setEnum(bool value) {
        ...
        public void setInterface(bool value) {
        ...
        public void setNestedAbstract(bool value) {
            setNestedModifier(Opcodes.ACC_ABSTRACT, value);
        }
        
        public void setNestedAnnotation(bool value) {
            setNestedModifier(Opcodes.ACC_ANNOTATION, value);
        }

        public void setNestedEnum(bool value) {
            setNestedModifier(Opcodes.ACC_ENUM, value);
        }

        public void setNestedFinal(bool value) {
            setNestedModifier(Opcodes.ACC_FINAL, value);
        }

        public void setNestedInterface(bool value) {
            setNestedModifier(Opcodes.ACC_INTERFACE, value);
        }

        public void setNestedPrivate(bool value) {
            setNestedModifier(Opcodes.ACC_PRIVATE, value);
        }

        public void setNestedProtected(bool value) {
            setNestedModifier(Opcodes.ACC_PROTECTED, value);
        }

        public void setNestedPublic(bool value) {
            setNestedModifier(Opcodes.ACC_PUBLIC, value);
        }

        public void setNestedStatic(bool value) {
            setNestedModifier(Opcodes.ACC_STATIC, value);
        }

        public void setNestedSynthetic(bool value) {
        ...
        private void setModifier(int modifier, bool value) {
            checkCreated();
            if (value) {
                modifiers |= modifier;
            } else {
        ...
        private void setNestedModifier(int modifier, bool value) {
            checkCreated();
            if (value) {
