...
namespace stab.reflection {
    ...
    public class AnnotationValueBuilder : AnnotationValue {
        public AnnotationValueBuilder(TypeInfo type, bool runtimeVisible)
            : super(type, runtimeVisible) {
        }
        
        public void setBooleanArgument(String name, bool value) {
        ...
        public AnnotationValueBuilder setAnnotationArgument(String name, TypeInfo type, bool runtimeVisible) {
    ...
    public class AnnotationArrayValueBuilder : ArrayAnnotationArgument {
        ...
        public AnnotationValueBuilder addAnnotationArgument(TypeInfo type, bool runtimeVisible) {
            var result = new AnnotationValueBuilder(type, runtimeVisible);
            elements.add(result);
            return result;
        }
