...
namespace cnatural.eclipse.editors {
	...
	class SyntaxNodeBounds {
		...
		bool isAfterOffset(int offset) {
			return this.StartToken.offset >= offset;
		}
		
		bool isBeforeOffset(int offset) {
	...
	class CompilationUnitHighlighter {
		...
		private class ExpressionHighlightHandler : ExpressionHandler<Void, Void> {
			...
			protected override Void handleAnonymousObjectCreation(AnonymousObjectCreationExpressionNode anonymousObject, Void source, bool nested) {
			...
			protected override Void handleCollectionInitializer(CollectionInitializerExpressionNode initializer, Void source, bool nested) {
			...
			protected override Void handleObjectInitializer(ObjectInitializerExpressionNode initializer, Void source, bool nested) {
				highlighter.setStartAndEndTokens(initializer);
