...
namespace stab.lang {
    ...
    /// <summary>
    /// Gives access to an iterator over a collection of bool values.
    /// </summary>
    /// <remarks>
	...
	public interface BooleanIterable : Iterable<Boolean> {
        /// <summary>
        /// Creates an iterator over a collection of bool values.
        /// </summary>
		BooleanIterator iterator();
	}
	
    /// <summary>
    /// Gives access to the elements of a collection of bool values.
    /// </summary>
	public interface BooleanIterator : Iterator<Boolean> {
        /// <summary>
        /// Advances to the next bool in the collection and returns it.
        /// </summary>
		bool nextBoolean();
	}
